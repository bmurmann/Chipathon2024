...
T {tcleval(raw info: [xschem raw info])} 220 610 0 0 0.3 0.3 {floater=1}
T {tcleval(
...
C {devices/lab_wire.sym} 410 130 0 0 {name=p7 sig_type=std_logic lab=Ib1}
...
C {devices/lab_wire.sym} 210 190 2 0 {name=p8 sig_type=std_logic lab=Ib1}
...
C {sky130_fd_pr/corner.sym} 700 100 0 0 {name=CORNER only_toplevel=false corner=tt}
C {devices/lab_wire.sym} 610 340 0 0 {name=p10 sig_type=std_logic lab=VDD}
C {devices/capa.sym} 790 450 0 0 {name=C2
m=1
value=\{cl\}
footprint=1206
device="ceramic capacitor"}
C {devices/gnd.sym} 790 480 0 0 {name=l1 lab=GND}
C {devices/lab_wire.sym} 550 400 0 0 {name=p16 sig_type=std_logic lab=Ib2}
C {devices/lab_wire.sym} 790 400 0 1 {name=p17 sig_type=std_logic lab=Vout_buf}
C {ota-5t.sym} 620 400 0 0 {name=x2}
C {devices/lab_wire.sym} 610 460 2 1 {name=p18 sig_type=std_logic lab=VSS}
C {devices/isource.sym} 280 120 0 0 {name=I1 value=\{ib\}}
C {devices/lab_wire.sym} 280 190 2 0 {name=p19 sig_type=std_logic lab=Ib2}
C {devices/lab_wire.sym} 280 50 0 0 {name=p20 sig_type=std_logic lab=VDD}
