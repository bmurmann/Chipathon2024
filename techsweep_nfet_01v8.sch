...
C {devices/vsource.sym} 730 -220 2 1 {name=vb value=\{vbx\} savecurrent=false}
...
C {devices/ngspice_get_value.sym} 930 -250 0 0 {name=r1 node=v(@m.xm1.msky130_fd_pr__nfet_01v8[vth])
descr="Vt="}
...
C {devices/ngspice_get_value.sym} 930 -210 0 0 {name=r2 node=@m.xm1.msky130_fd_pr__nfet_01v8[cgg]
descr="cgg="}
...
descr="gm/gds="}
C {devices/ngspice_get_value.sym} 930 -170 0 0 {name=r3 node=@m.xm1.msky130_fd_pr__nfet_01v8[capbd]
descr="capdb="}
C {devices/ngspice_get_value.sym} 930 -130 0 0 {name=r5 node=@m.xm1.msky130_fd_pr__nfet_01v8[capbs]
descr="capbs="}
