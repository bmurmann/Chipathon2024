...
C {devices/ngspice_get_value.sym} 930 -250 0 0 {name=r1 node=v(@m.xm1.msky130_fd_pr__pfet_01v8[vth])
descr="Vt="}
...
C {devices/ngspice_get_value.sym} 930 -210 0 0 {name=r2 node=@m.xm1.msky130_fd_pr__pfet_01v8[cgg]
descr="cgg="}
...
descr="gm/gds="}
C {devices/ngspice_get_value.sym} 930 -170 0 0 {name=r3 node=@m.xm1.msky130_fd_pr__pfet_01v8[capbd]
descr="capdb="}
C {devices/ngspice_get_value.sym} 930 -130 0 0 {name=r5 node=@m.xm1.msky130_fd_pr__pfet_01v8[capbs]
descr="capbs="}
...
.save b d g
"}
C {sky130_fd_pr/pfet_01v8.sym} 590 -220 0 0 {name=M1
L=\{lx\}
W=\{wx\}
nf=1
mult=1
